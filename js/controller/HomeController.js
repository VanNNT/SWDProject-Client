...
SWDApp.controller('HomeController', function($scope, $mdDialog, $mdMedia,$location,
    ...
    function getAllSuccess(response){
        ...
        localStorage.setItem(LOCAL_ALL_MOVIES,JSON.stringify($scope.listFilm));
    }
